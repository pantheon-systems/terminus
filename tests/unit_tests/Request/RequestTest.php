...
class RequestTest extends TerminusTestCase
{
    ...
    public function testDownloadPathExists()
    {
        ...
        $this->expectException(TerminusException::class, "Target file $target already exists.");
    ...
    public function testRequestDontRetry()
    {
        ...
        $this->expectException(ClientException::class, "Something bad happened. And it is your fault.");
