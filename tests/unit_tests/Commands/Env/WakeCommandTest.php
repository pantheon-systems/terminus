...
class WakeCommandTest extends EnvCommandTest
{
    ...
    public function testWakeFailUnreachable()
    {
        ...
        $this->expectException(TerminusException::class, 'Could not reach dev');
    ...
    public function testWakeFail()
    {
        ...
        $this->expectException(TerminusException::class, 'Pantheon headers missing, which is not quite right.');
