...
class CloneContentCommandTest extends EnvCommandTest
{
    ...
    public function testCloneFilesToUninitialized()
    {
        ...
        $this->expectExceptionMessage("$site_name's {$this->environment->id} environment cannot be cloned into because it has not been initialized. Please run `env:deploy $site_name.{$this->environment->id}` to initialize it.");
    ...
    public function testCloneFilesFromUninitialized()
    {
        ...
        $this->expectException(TerminusException::class);
        $this->expectExceptionMessage("$site_name's {$this->environment->id} environment cannot be cloned from because it has not been initialized. Please run `env:deploy $site_name.{$this->environment->id}` to initialize it.");
