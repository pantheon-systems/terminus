...
class CloneCommandTest extends EnvCommandTest
{
    ...
    public function testCloneFilesFromUninitialized()
    {
        ...
        $this->setExpectedException(
            ...
            "$site_name's {$this->environment->id} environment cannot be cloned because it has not been initialized. "
            . "Please run `env:deploy $site_name.{$this->environment->id}` to initialize it."
        );
