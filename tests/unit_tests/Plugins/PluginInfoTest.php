...
class PluginInfoTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests PluginInfo failing to construct because the composer.json does not contain a terminus property in its
     * extras
     */
    ...
    public function testFailInvalidNamespace()
    {
        ...
        $this->setExpectedException(
            TerminusException::class,
            'The namespace "OrgName\\\\PluginName" in the composer.json autoload psr-4 section must end with a '
            . 'namespace separator. Should be "OrgName\\\\PluginName\\\\"'
        );
        new PluginInfo($dir);
    }
