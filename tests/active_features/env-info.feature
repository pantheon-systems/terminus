Feature: Displaying environmental information
  ...
  Scenario: Prompt for environment argument using a number
    ...
    Then I should get: "Please choose an environment for this command:"
    Then I should get: "1) dev"
    Then I should get: "2) test"
    Then I should get: "3) live"
    Then I should get: "4) my-multidev"
