Feature: View site workflow information
  ...
  Scenario: List workflows
    When I run "[[executable]] workflow:list [[test_site_name]]"
  ...
  Scenario: Show a specific Workflow's status
    When I run "[[executable]] workflow:info:status [[test_site_name]] --id=11111111-1111-1111-1111-111111111111"
  ...
  Scenario: Show a specific Workflow's operations
    When I run "[[executable]] workflow:info:operations [[test_site_name]] --id=11111111-1111-1111-1111-111111111111"
  ...
  Scenario: Try show a Workflow that has no logs
    When I run "[[executable]] workflow:info:logs [[test_site_name]] --id=11111111-1111-1111-1111-111111111111"
  ...
  Scenario: Show the most recent set of logs for a workflow that has logs
    When I run "[[executable]] workflow:info:logs [[test_site_name]]"
