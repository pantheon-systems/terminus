...
class FeatureContext extends BehatContext {
  ...
  */
  ...
  public function iAmAuthenticated() {
    $output = $this->iRun(
      "terminus auth login [[username]] --password=[[password]]"
    );
  ...
  /**
    * @Given /^a site named "([^"]*)"$/
    *
    * @param [string] $site_name Name of site to check for/create
    * @return [boolean] True if site exists
    */
  ...
  * @return [string] $this->output All CL output from command
  */
