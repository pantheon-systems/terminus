Feature: Organizational users
  ...
  Scenario: Add a new member to a team
    When I run "terminus org:team:add --org=[[organization_name]] --member=[[other_user]] --role=team_member"
    Then I should get:
    """
  ...
  Scenario: Removing a new member from a team
    When I run "terminus org:team:remove --org=[[organization_name]] --member=[[other_user]]"
    Then I should get:
    """
  ...
  Scenario: Changing a team member's role
    When I run "terminus org:team:role --org=[[organization_name]] --member=[[other_user]] --role=developer"
    Then I should get:
    """
