Feature: Set a site's connection mode
  ...
  Scenario: Setting connection mode to git
    When I run "terminus connection:set git --site=[[test_site_name]] --env=dev"
    Then I should get: "."
    And I should get:
    """
  ...
  Scenario: Setting connection mode to sftp
    When I run "terminus connection:set sftp --site=[[test_site_name]] --env=dev"
    Then I should get: "."
    And I should get:
    """
  ...
  Scenario: Failing to set connection mode to invalid mode
    When I run "terminus connection:set invalid --site=[[test_site_name]] --env=dev"
    Then I should get: "."
    And I should get:
    """
