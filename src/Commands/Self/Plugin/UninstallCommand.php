...
{
    public const NOT_INSTALLED_MESSAGE = '{project} is not installed.';

    public const SUCCESS_MESSAGE = '{project} was removed successfully.';

    public const USAGE_MESSAGE = 'terminus self:plugin:<uninstall|remove> <project> [project 2] ...';

    public const UNINSTALL_COMMAND =
        'composer remove -d {dir} {project} --no-update';

    public const REMOVE_PATH_REPO_COMMAND =
     ...
     *     plugin:uninstall plugin:remove plugin:rm plugin:delete
     *
     * @usage <project> [project] ... Uninstalls the indicated plugins.
     *
     * @param array $projects A list of one or more installed projects or
     *     plugins to remove
     *
