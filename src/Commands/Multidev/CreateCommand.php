...
class CreateCommand extends TerminusCommand implements SiteAwareInterface
{
     ...
     *     Creates the Multidev environment, <multidev>, within <site> with database and files from the <env> environment. If there is an existing git branch named <multidev>, then it will be used when the new environment is created.
     */
